...
export function ScriptInput({
  ...
  // Al editor se le pide alto minimo en vez de filas: 12px con interlineado 1.6 son 1.2rem por
  // linea, mas un respiro para el relleno vertical.
  const minHeight: string = `${(rows * 1.2 + 0.75).toFixed(2)}rem`;
