...
export function DependencyCheckboxRow({
  ...
  return (
    ...
    <label className="flex items-center gap-2 rounded-md border border-slate-200 px-2.5 py-1.5 text-sm text-slate-700 dark:border-slate-700 dark:text-slate-200">
