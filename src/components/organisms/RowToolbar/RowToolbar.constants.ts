...
// su propia X de borrar. El z-10 es porque vive fuera de la caja de la fila.
export const ROW_TOOLBAR_CLASSES: string =
  "absolute -top-5 right-2 z-10 flex items-center gap-0.5 rounded-lg border border-border bg-surface p-0.5 shadow-sm dark:bg-surface-raised";
